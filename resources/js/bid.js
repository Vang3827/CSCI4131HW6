document.addEventListener("DOMContentLoaded", () => {
    ...
    function toggleBidButtonText() {
      if (btn.value === "Place Bid") {
        btn.value = "Cancel Bid";
      } else {
        btn.value = "Place Bid"; 
      }
    }
    ...
    btn.addEventListener("click", () => {
      formInput.style.display = formInput.style.display === "block" ? "none" : "block";
      toggleBidButtonText(); // Toggle the button text when clicked
    });
  
    // Handle the form to place a bid
